    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 top-12 z-50 w-80 sm:w-96 rounded-lg border border-border bg-card shadow-elevated overflow-hidden">
                ...
                notifications.map((n) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        'w-full text-left flex gap-3 px-4 py-3 border-b border-border hover:bg-muted/50 transition-colors',
