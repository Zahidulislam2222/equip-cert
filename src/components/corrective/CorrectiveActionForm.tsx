...
export function CorrectiveActionForm({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50">
      <div className="w-full max-w-lg bg-card rounded-t-2xl sm:rounded-lg shadow-elevated border border-border max-h-[90vh] overflow-auto">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-input bg-card px-4 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all resize-none"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            {photoUrl ? (
              ...
              <Button type="button" variant="outline" onClick={takePhoto} className="w-full gap-2 rounded-lg">
          ...
          {/* Submit */}
          <Button type="submit" disabled={isSubmitting || !description.trim()} variant="destructive" className="w-full gap-2 h-12 rounded-lg">
