    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex flex-1 flex-col px-4 py-6">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-step-3 font-extrabold font-display text-foreground">
        ...
        <StaggerContainer className="mb-6 grid grid-cols-2 gap-4">
          <StaggerItem>
            <div className="rounded-lg bg-card border border-border p-4 shadow-card">
              <p className="text-step-2 font-extrabold font-display text-foreground">{todayCount}</p>
              <p className="text-sm text-muted-foreground">Today&apos;s Tasks</p>
            </div>
          </StaggerItem>
          <StaggerItem>
            <div className="rounded-lg bg-success-bg border border-success/20 p-4 shadow-card">
              <p className="text-step-2 font-extrabold font-display text-success">{completedCount}</p>
        ...
        <div className="flex flex-1 flex-col gap-4">
          ...
          <motion.button
            ...
            className="group flex h-32 w-full items-center justify-between px-8 rounded-lg shadow-card hover:shadow-elevated transition-shadow border-2 border-transparent gradient-primary text-primary-foreground"
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <h3 className="text-step-1 font-bold font-display">Manual Check</h3>
          ...
          <motion.button
            ...
            className="group flex h-32 w-full items-center justify-between px-8 rounded-lg shadow-card hover:shadow-elevated transition-shadow bg-card border-2 border-primary/20 hover:border-primary/50 text-foreground"
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <h3 className="text-step-1 font-bold font-display">AI Guided</h3>
