  ...
  return (
    <MotionPage className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-step-3 font-extrabold font-display text-foreground">Inspection Schedule</h1>
        ...
        <StaggerContainer className="space-y-3">
          {schedules.map((schedule) => {
            ...
            return (
              ...
              <div
                className={cn(
                  'rounded-lg border bg-card p-5 shadow-sm transition-all hover:shadow-card',
