  ...
  return (
    <MotionPage className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-step-3 font-extrabold font-display text-foreground">Equipment Registry</h1>
          <p className="text-muted-foreground">Manage your fleet&apos;s equipment inventory</p>
        </div>
        <Button onClick={() => setShowForm(!showForm)} className="gap-2 rounded-lg shadow-card">
      ...
      <AnimatePresence>
        {showForm && (
          <motion.form
            ...
            className="rounded-lg border border-border bg-card p-6 shadow-card space-y-4 overflow-hidden"
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <input
                ...
                className="rounded-lg border border-input bg-card px-4 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all"
              />
              <input
                value={formData.type}
              ...
              <input
                ...
                className="rounded-lg border border-input bg-card px-4 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all font-mono"
              />
              <input
            ...
            <div className="flex gap-3">
              <Button type="submit" disabled={isSaving} className="gap-2 rounded-lg">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-input bg-card pl-10 pr-4 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all"
        />
      </div>
