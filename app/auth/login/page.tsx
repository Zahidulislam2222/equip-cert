    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-sidebar p-12 flex-col justify-between text-white">
        ...
        <div className="relative space-y-8">
          ...
          <StaggerContainer className="flex gap-4" delay={0.2}>
            {[
              ...
              <StaggerItem key={stat.label}>
                <div className="rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 px-5 py-4">
        ...
        >
          ...
          <AnimatePresence mode="wait">
            {magicLinkSent ? (
              <motion.div
                key="magic-link-sent"
                className="rounded-2xl border border-success/20 bg-success-bg p-8 text-center"
